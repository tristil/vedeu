module Vedeu
  ...
  class ProgressBar
    ...
    # @param attributes [Hash<Symbol => Boolean, Fixnum]
    # @option attributes height [Fixnum] The height including border (if
    #   enabled)
    # @option attributes name [String] The name of the progress bar.
    # @option attributes progress [Fixnum] How much work have we done? (tasks
    #   completed)
    # @option attributes tasks [Fixnum] Total number of tasks to complete.
    # @option attributes width [Fixnum] The width including border (if enabled)
    # @return [Vedeu::ProgressBar]
